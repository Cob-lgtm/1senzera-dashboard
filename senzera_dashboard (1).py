...
v5 Änderungen:
  - Logo: Weißer Hintergrund (Corinna-Wunsch)
  - Downloads: Alle Download-Optionen NUR im Management-Bericht Tab
  - Typografie: Verbessertes Font-Rendering (Antialiasing)
  - Refactoring: Daten-Export Sektion entfernt (konsolidiert in Tab 3)
"""
...
# ┌─────────────────────────────────────────────────────────────┐
# │  LOGO_B64: Bitte den Wert aus der v4-Datei hier einfügen!  │
# │  (Zeile: LOGO_B64 = "iVBORw0KGgoAAAA...")                  │
# │  Das Logo ist ein ~50KB Base64-String des Senzera-Logos.    │
# └─────────────────────────────────────────────────────────────┘
LOGO_B64 = ""
...
# ══════════════════════════════════════════════════════════════════
# 4 · CSS INJECTION (v5: Font-Smoothing hinzugefügt)
# ══════════════════════════════════════════════════════════════════
...
# ══════════════════════════════════════════════════════════════════
# 7 · SIDEBAR (v5: Logo mit weißem Hintergrund)
# ══════════════════════════════════════════════════════════════════
with st.sidebar:

    # ── Branding mit echtem Senzera Logo ───────────────────────
    logo_bg = "#FFFFFF"  # v5: Weißer Hintergrund (Corinna-Wunsch)
    st.markdown(
...
# ──────────────────────────────────────────────────────────────────
# TAB 3 · MANAGEMENT-BERICHT (v5: ALLE Downloads hier konsolidiert)
# ──────────────────────────────────────────────────────────────────
with tab3:
    section_title(
        "Management-Bericht",
    ...
    # ── v5: ALLE DOWNLOADS HIER KONSOLIDIERT ─────────────────────
    st.markdown("<div style='height:10px'></div>", unsafe_allow_html=True)
...
# ──────────────────────────────────────────────────────────────────
# TAB 4 · TEAM-PERFORMER (v5: Downloads entfernt → siehe Tab 3)
# ──────────────────────────────────────────────────────────────────
...
# ══════════════════════════════════════════════════════════════════
# 13 · FOOTER  (v5: Downloads jetzt nur im Management-Bericht Tab)
# ══════════════════════════════════════════════════════════════════
st.divider()
st.markdown(
